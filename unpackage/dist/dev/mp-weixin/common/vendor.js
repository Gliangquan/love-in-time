...
function normalizeStyle(value2) {
  if (isArray$1(value2)) {
    ...
    return res;
  } else if (isString(value2) || isObject$3(value2)) {
    return value2;
  }
}
...
(function(module2, exports2) {
  (function(d2, f2) {
    ...
    d2.exports = v2, d2.exports.parse = v2, d2.exports.parseString = g2, d2.exports.splitCookiesString = C2;
    var y2 = d2.exports;
    class x {
    ...
    class b2 {
      ...
      getCookie(e2 = "", t2 = "", r2 = "/") {
        let s2, i2 = k.getCookieScopeDomain(t2);
      ...
      parse(e2 = "", t2) {
        ...
        return r2.map((s2) => (s2.domain = k.normalizeDomain(s2.domain) || t2, new _2(s2)));
      }
      stringify(e2) {
    ...
    return function() {
      const a2 = new b2();
      function e2(i2) {
        if (i2.cookie = i2.cookie === void 0 || !!i2.cookie, i2.dataType = i2.dataType || "json", i2.header = i2.headers = i2.header || i2.headers || {}, i2.header["X-Requested-With"] = "XMLHttpRequest", i2.dataType === "json" && (i2.header.Accept = "application/json, text/plain, */*"), n2.platform !== "h5" && i2.cookie) {
          let o2 = (i2.url || "").split("/")[2], l2 = i2.url.split(o2).pop(), h2 = a2.getRequestCookies(o2, l2);
          i2.header.Cookie = h2;
          let c2 = i2.success;
      ...
      return a2.config = function(i2) {
        i2 = Object.assign({ requestAlias: "requestWithCookie", uploadFileAlias: "uploadFileWithCookie", downloadFileAlias: "downloadFileWithCookie" }, i2), i2.requestAlias && Object.defineProperty(n2, i2.requestAlias, { value: t2 }), i2.uploadFileAlias && Object.defineProperty(n2, i2.uploadFileAlias, { value: r2 }), i2.downloadFileAlias && Object.defineProperty(n2, i2.downloadFileAlias, { value: s2 });
      }, a2;
    }();
  });
})(weappCookie_umd);
...
const pages = [
  {
    path: "pages/pagetemplate/pagetemplate",
    style: {
  ...
  {
    path: "pages/dish/loverAddDish",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/dish/loverAddCategories",
    style: {
      navigationBarTitleText: ""
    }
  }
